...
Route::prefix('user')->name('user')->group(function () {
    ...
    Route::prefix('/comment')->name('comment.')->group(function () {
        ...
        Route::post('/{category}/update', [CommentController::class, 'update'])->name('update');
        Route::post('/{category}/delete', [CommentController::class, 'delete'])->name('delete');

    });

});

//Route::post('/{tag}/posts', [TagController::class, 'getPostByTag'])->name('post_by_tag');
